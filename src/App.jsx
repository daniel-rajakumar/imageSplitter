...
const Icons = {
  ...
  Ratio: () => <svg viewBox="0 0 24 24"><path d="M5 5h14v14H5V5zm2 2v10h10V7H7zm2 2h6v2H9V9zm0 4h4v2H9v-2z"/></svg>,
...
export default function App() {
  ...
  // UI State
  const [activeTab, setActiveTab] = useState('grid'); // 'grid' | 'ratio' | 'info'
